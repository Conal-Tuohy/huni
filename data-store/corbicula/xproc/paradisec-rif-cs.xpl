...
>
	...
	<drone:list-new-records 
		name="harvest" 
		base-uri="http://catalog.paradisec.org.au/oai/collection" 
		cache-location="/data/xml/paradisec-rif-cs/" 
		metadata-prefix="rif"/>
	...
	<p:for-each name="transform-record-to-rdf">
		...
		<drone:xml-to-rdf name="rdf" xslt="paradisec-rif-cs-to-rdf.xsl" resource-base-uri="http://corbicula.huni.net.au/data/paradisec/"/>
