...
- Create PhoneListCtrl view
  ...
  - Move existing HTML from index.html to partials/project-list.html
...
The following docs apply to all angular-seed projects and since the virtualab tutorial is a project
